...
- [x] Confirm the public repository owner and name: `cortezbuilds/happy-people-agent-skills`.
- [x] Choose an explicit source-available license: PolyForm Noncommercial 1.0.0.
- [x] Configure the exact verified GitHub no-reply author and committer address.
